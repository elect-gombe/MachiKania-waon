...
extern unsigned int NVMemWriteWord(void* address, unsigned int data);
extern unsigned int NVMemErasePage(void* address);
extern unsigned int NVMemWriteRow(void* address, void* data);
extern unsigned int NVMemClearError(void);
